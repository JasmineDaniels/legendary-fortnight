package com.cooksys.social_media_demo.controllers.advice;

import com.cooksys.social_media_demo.dtos.ErrorDto;
...
@ControllerAdvice(basePackages = {"com.cooksys.social_media_demo.controllers"})
@ResponseBody
